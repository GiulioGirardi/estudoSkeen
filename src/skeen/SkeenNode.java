...
public class SkeenNode extends SkeenServerProxy {
    ...
    protected void receiveStep2Msg(SkeenMessage m){
        ...
        //Busca a mensagem mais nova e coloca na fila de solicitação "ordered"
        ...
        //Busca uma mensagem na fila de solicitações "ordered" e compara se tem uma mensagem mais nova na fila de mensagens pendentes "pending" (?)
        //Caso exista uma mensagem mais nova em pending a mensagem é removida de ordered e é entregue
        for(;;){
